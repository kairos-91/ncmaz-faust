  ...
  return (
    <header className="flex h-16 items-center justify-between gap-3 border-b border-neutral-200 bg-white px-4 dark:border-neutral-800 dark:bg-neutral-900 md:px-10">
      <div className="flex min-w-0 items-center gap-3">
        ...
        {bcvRate && (
          <span className="hidden items-center gap-1.5 whitespace-nowrap rounded-full bg-amber-50 px-3 py-1 text-xs font-semibold text-amber-700 dark:bg-amber-400/10 dark:text-amber-400 sm:inline-flex">
