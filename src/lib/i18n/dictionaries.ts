...
const es = {
  ...
  profileMenu: {
    ...
    saving: "Guardando...",
    save: "Guardar",
    passwordSuccess: "Tu contraseña se actualizó correctamente.",
    passwordErrorGeneric: "No pudimos actualizar tu contraseña. Intenta de nuevo.",
    deleteWarning:
      "Esta acción es permanente: se borrará tu restaurante, tu menú, tus pedidos y toda la información asociada. Tu URL quedará libre para que otro restaurante pueda usarla.",
  ...
  restaurantForm: {
    ...
    slugUnavailable: "Esa URL ya está en uso. Prueba con una de estas:",
    ...
    stateLabel: "Ciudad",
    stateSelectPlaceholder: "Maracay",
    countryLabel: "Estado",
    ...
    menuLayoutLabel: "Diseño del menú",
    menuLayoutHint: "Así se verán las tarjetas de los platos en tu menú público.",
    menuLayoutListLabel: "Lista",
    menuLayoutGridLabel: "Cuadrícula",
    publishLabel: "Publicar menú (visible en tu URL pública)",
    deliveryZonesLabel: "Zonas de envío",
    deliveryZonesNamePlaceholder: "Nombre de la zona",
    deliveryZonesFeePlaceholder: "Costo",
    deliveryZonesAdd: "Agregar zona",
    deliveryZonesRemove: "Eliminar zona",
    deliveryZonesHint:
      "Usa 0 si el envío es gratis. Tus clientes elegirán una zona al pedir delivery y se sumará al total.",
    saving: "Guardando...",
  ...
  tablesPage: {
    title: "Mesas",
    subtitle:
      "Organiza tus mesas por zona y capacidad. Genera un QR por mesa para que tus clientes pidan directo desde ahí, solo para comer en el local.",
  },
  tablesManager: {
    empty: "Aún no agregaste ninguna mesa.",
    zoneLabel: "Zona (opcional)",
    zonePlaceholder: "Terraza, Salón, Barra...",
    nameLabel: "Nombre o número",
    ...
    markOccupied: "Marcar ocupada",
    peopleSuffix: (n: number) => `${n} ${n === 1 ? "persona" : "personas"}`,
    viewQr: "Ver QR",
    qrModalTitle: (name: string) => `QR de ${name}`,
    qrHint:
      "Al escanearlo, el cliente abre tu menú con el pedido fijado en \"Comer en el local\" y esta mesa ya seleccionada.",
    qrDownload: "Descargar QR",
    qrClose: "Cerrar",
    delete: "Eliminar",
    deleteConfirm: (name: string) => `¿Eliminar la mesa "${name}"?`,
  },
  kitchenBoard: {
    staffRosterTitle: "Personal de cocina",
    queuedColumn: "En cola",
    queuedEmpty: "No hay pedidos en cola.",
    preparingColumn: "Preparando",
    preparingEmpty: "No hay pedidos en preparación.",
    readyColumn: "Listo",
    readyEmpty: "No hay pedidos listos.",
    table: "Mesa",
    minutesAgo: (minutes: number) =>
      minutes === 0 ? "Recién enviado" : `Hace ${minutes} min`,
  ...
  menuItemForm: {
    ...
    priceLabel: "Precio",
    originalPriceLabel: "Precio antes del descuento (opcional)",
    originalPriceHint:
      "Déjalo vacío si no está en descuento. Debe ser mayor al precio actual — se muestra tachado en el menú público.",
    descriptionLabel: "Descripción",
    ...
    extrasNameColumnLabel: "Nombre",
    extrasPriceColumnLabel: "Precio",
  ...
  ordersManager: {
    ...
    inKitchen: "En cocina",
    kitchenPreparing: "Preparando",
    kitchenReady: "Listo en cocina",
...
const en: typeof es = {
  ...
  profileMenu: {
    ...
    passwordErrorGeneric: "We couldn't update your password. Please try again.",
    deleteWarning:
      "This action is permanent: your restaurant, menu, orders and all related data will be deleted. Your URL will become free for another restaurant to use.",
  ...
  restaurantForm: {
    ...
    slugUnavailable: "That URL is already taken. Try one of these:",
    ...
    menuLayoutLabel: "Menu layout",
    menuLayoutHint: "This is how dish cards will look on your public menu.",
    menuLayoutListLabel: "List",
    menuLayoutGridLabel: "Grid",
    publishLabel: "Publish menu (visible at your public URL)",
    deliveryZonesLabel: "Delivery zones",
    deliveryZonesNamePlaceholder: "Zone name",
    deliveryZonesFeePlaceholder: "Fee",
    deliveryZonesAdd: "Add zone",
    deliveryZonesRemove: "Remove zone",
    deliveryZonesHint:
      "Use 0 if delivery is free. Customers pick a zone when ordering delivery and it's added to the total.",
    saving: "Saving...",
  ...
  tablesPage: {
    title: "Tables",
    subtitle:
      "Organize your tables by zone and capacity. Generate a QR per table so customers can order right from it, dine-in only.",
  },
  tablesManager: {
    empty: "You haven't added any tables yet.",
    zoneLabel: "Zone (optional)",
    zonePlaceholder: "Patio, Dining room, Bar...",
    nameLabel: "Name or number",
    ...
    peopleSuffix: (n: number) => `${n} ${n === 1 ? "person" : "people"}`,
    viewQr: "View QR",
    qrModalTitle: (name: string) => `QR for ${name}`,
    qrHint:
      "Scanning it opens your menu with the order type locked to \"Dine in\" and this table already selected.",
    qrDownload: "Download QR",
    qrClose: "Close",
    delete: "Delete",
    deleteConfirm: (name: string) => `Delete table "${name}"?`,
  },
  kitchenBoard: {
    staffRosterTitle: "Kitchen staff",
    queuedColumn: "Queued",
    queuedEmpty: "No orders queued.",
    ...
    table: "Table",
    minutesAgo: (minutes: number) =>
      minutes === 0 ? "Just sent" : `${minutes} min ago`,
  ...
  menuItemForm: {
    ...
    priceLabel: "Price",
    originalPriceLabel: "Price before discount (optional)",
    originalPriceHint:
      "Leave empty if it's not discounted. Must be greater than the current price — shown crossed out on the public menu.",
    descriptionLabel: "Description",
    ...
    extrasNameColumnLabel: "Name",
    extrasPriceColumnLabel: "Price",
